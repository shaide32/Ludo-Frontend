...
const createPlayerTokens = () => {
    ...
    playerTokens.push(new PlayerToken(7, PLAYER_TYPE.green, 21, TOKEN_STATUS.active));
    ...
    playerTokens.push(new PlayerToken(14, PLAYER_TYPE.blue, 63, TOKEN_STATUS.active));
