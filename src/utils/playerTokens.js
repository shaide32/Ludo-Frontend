...
const createPlayerTokens = () => {
    ...
    playerTokens.push(new PlayerToken(2, PLAYER_TYPE.red, 6, TOKEN_STATUS.active));
    ...
    playerTokens.push(new PlayerToken(7, PLAYER_TYPE.green, -1, TOKEN_STATUS.finished));
    playerTokens.push(new PlayerToken(8, PLAYER_TYPE.green, -1));
    playerTokens.push(new PlayerToken(9, PLAYER_TYPE.yellow, -1));
    playerTokens.push(new PlayerToken(10, PLAYER_TYPE.yellow, -1, TOKEN_STATUS.finished));
    ...
    playerTokens.push(new PlayerToken(14, PLAYER_TYPE.blue, -1, TOKEN_STATUS.finished));
