...
const createPlayerTokens = () => {
    ...
    playerTokens.push(new PlayerToken(2, PLAYER_TYPE.red, -1));
    ...
    playerTokens.push(new PlayerToken(10, PLAYER_TYPE.yellow, -1));
    ...
    playerTokens.push(new PlayerToken(14, PLAYER_TYPE.blue, -1));
